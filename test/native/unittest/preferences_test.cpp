 ...
 * @tc.desc: put special characters
 * @tc.type: FUNC
 */
HWTEST_F(PreferencesTest, NativePreferencesTest_033, TestSize.Level1)
{
    pref->PutString(KEY_TEST_STRING_ELEMENT, "\x80");

    std::string ret = pref->GetString(KEY_TEST_STRING_ELEMENT, "test1");
    EXPECT_EQ(ret, "\x80");
}

/**
 * @tc.name: NativePreferencesTest_034
 * @tc.desc: RegisterObserver testing
 * @tc.type: FUNC
 */
HWTEST_F(PreferencesTest, NativePreferencesTest_034, TestSize.Level1)
{
