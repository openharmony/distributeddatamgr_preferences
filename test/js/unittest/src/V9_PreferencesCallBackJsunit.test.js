...
describe('preferencesTest', async function () {
    ...
    //on OK parsers
    it('testPreferencesCallback013', 0, async function () {
        console.log("testPreferencesCallback013 begin.")
        try {
            mPreference.clear();
    ...
    //on err parsers
    it('testPreferencesCallback014', 0, async function () {
        console.log("testPreferencesCallback014 begin.")
        try {
            var observer = function (key) {
                if (key) {
                    console.info('testPreferencesCallback014 key' + key);
                    expect(false).assertTrue()
                }
                expect("abcd").assertEqual(key);
            };
    ...
    //off OK parsers
    it('testPreferencesCallback015', 0, async function () {
        try {
    ...
    //off err parsers
    it('testPreferencesCallback016', 0, async function () {
        try {
            console.log("testPreferencesCallback016 begin.")
            var observer = function (key) {
                console.info('testPreferencesCallback016 key' + key);
                expect('').assertEqual(key);
            };
            await mPreference.on('change', observer);
