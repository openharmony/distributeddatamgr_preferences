...
FFI_EXPORT int FfiOHOSPreferencesOff = 0;
FFI_EXPORT int FfiOHOSPreferencesOffAll = 0;
FFI_EXPORT int FfiOHOSPreferencesGet = 0;
FFI_EXPORT int FfiOHOSPreferencesPut = 0;
