...
public:
    ...
    ValueType GetSync(::taihe::string_view key, ValueType const& defValue);

    uintptr_t GetAllSync();

    bool HasSync(::taihe::string_view key);

    void PutSync(::taihe::string_view key, ValueType const& value);
    ...
    void OnChange(::taihe::callback_view<void(::taihe::string_view)> cb, uintptr_t opq);

    void OffChange(::taihe::optional_view<uintptr_t> opq);

    void OnMultiProcessChange(::taihe::callback_view<void(::taihe::string_view)> cb, uintptr_t opq);

    void OffMultiProcessChange(::taihe::optional_view<uintptr_t> opq);

    void OnDataChange(::taihe::array_view<::taihe::string> keys,
        ::taihe::callback_view<void(::taihe::map_view<::taihe::string, ValueType>)> cb, uintptr_t opq);
