...
using ArrayValueType = ohos::data::preferences::ArrayValueType;

NativePreferences::PreferencesValue ConvertToPreferencesValue(const ValueType &value);

ValueType ConvertToValueType(const NativePreferences::PreferencesValue &value);
